    ...
    return (
        <Command className="rounded-xl border-0 bg-background/50 backdrop-blur-xl min-h-[315px]">
            ...
            <CommandList>
                ...
                {agents?.length === 0 && loading && <div className="w-full h-auto flex flex-col gap-2 pt-2">
                    ...
                    {agents && agents.length !== 0 && !loading && agents.map((agent, index) => (
                        ...
                        >
                            ...
                            group-hover:bg-white/10">
                                {agent.agentId === "swapAgent" ? <ArrowLeftRight className="h-5 w-5" /> :
                                    agent.agentId === "bridgeAgent" ? <Layers className="h-5 w-5" /> :
