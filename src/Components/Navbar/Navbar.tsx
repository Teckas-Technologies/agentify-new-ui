        ...
        <div className="flex flex-col h-full">
          ...
          <div>
            ...
            <ul className="mt-6 space-y-2" style={{ fontFamily: "manrope" }}>
              <li>
                <button
                  className={`flex cursor-pointer items-center w-full gap-2 px-3 py-2 rounded-lg text-xs transition-colors ${
              ...
              <li>
                ...
                >
                  ...
                  {(!isCollapsed || isMobileNavVisible) && (
                    <span className="text-sm font-semibold">Browse Agents</span>
                  )}
                </button>
              </li>
            </ul>
            ...
            {(!isCollapsed || isMobileNavVisible) && (
              <div className="mt-4 space-y-4">
                <div
                  ...
                  className="build-agent block flex items-center justify-between text-gray-400 text-sm font-semibold hover:bg-gray-800 px-2 py-2 rounded-lg"
                >
                  <Link
                    href="#"
                ...
                <div
                  ...
                  className="build-agent block flex items-center justify-between gap-1 text-gray-400 text-sm font-semibold hover:bg-gray-800 px-2 py-2 rounded-lg"
                >
                  <Link
                    href="#"
...
>
  ...
  {(!isCollapsed || isMobileNavVisible) && (
    <h2
      ...
      style={{ fontFamily: "manrope" }}
    >
      {(!user && !address) ? "Connect" : "Disconnect"}
    </h2>
  )}
